...
const CreatorProfileForm = ({
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            disabled={loading}
            className="bg-white/50 border border-[#C8C8C9] focus:ring-2 focus:ring-[#0EA5E9] rounded-xl"
      ...
      <div className="space-y-2">
        <Label htmlFor="bio" className="text-sm font-medium text-[#222222]">Bio</Label>
        <Textarea
          id="bio"
          ...
          className="bg-white/50 border border-[#C8C8C9] focus:ring-2 focus:ring-[#0EA5E9] rounded-xl resize-none h-32"
        />
      </div>

      <div className="space-y-2">
        <Label htmlFor="location" className="text-sm font-medium text-[#222222]">Location</Label>
        <Input
          id="location"
      ...
      <div className="space-y-2">
        <Label htmlFor="instagram" className="text-sm font-medium text-[#222222]">Instagram Username</Label>
        <Input
          id="instagram"
      ...
      <div className="space-y-2">
        <Label htmlFor="website" className="text-sm font-medium text-[#222222]">Website</Label>
        <Input
          id="website"
