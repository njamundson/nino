  ...
  return (
    <div className="flex min-h-screen bg-nino-bg">
      ...
      <main className={`flex-1 ${isMobile ? 'w-full' : 'ml-64'}`}>
        {/* Fixed header */}
        <header className="fixed top-0 right-0 left-0 lg:left-64 z-20">
          <div className="relative py-6 px-4 md:px-8 bg-nino-bg/80 backdrop-blur-sm border-b border-gray-100/50">
            <DashboardHeader />
          </div>
        </header>
